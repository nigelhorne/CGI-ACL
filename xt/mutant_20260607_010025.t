...
# Source:  # so that mutations to the clone do not affect the original.
...
# Source:  # Use // (defined-or) not || to avoid treating "0" or "" as absent.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
...
# --- SURVIVOR: COND_INV_870_2 (MEDIUM) line 870 in _is_cloud_host() ---
# Source:  #             undef is returned when:
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_870_2 line 870 in _is_cloud_host()';
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::ACL requires constructor arguments, add them here.
    my $obj = new_ok('CGI::ACL');
    # TODO: exercise line 870 in _is_cloud_host() to detect the mutant
    fail('COND_INV_870_2: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_882_27_!= (HIGH) line 882 in _is_cloud_host() ---
# Source:  #             between eval exit and the outer alarm(0) call.
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (1 variant):
#   Numeric boundary flip == to !=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_882_27_!= line 882 in _is_cloud_host()';
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::ACL requires constructor arguments, add them here.
    my $obj = new_ok('CGI::ACL');
    # TODO: exercise line 882 in _is_cloud_host() to detect the mutant
...
# Source:  $packed = inet_aton($ip) or return;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# --- SURVIVOR: NUM_BOUNDARY_938_13_!= (HIGH) line 938 in _verified_rdns() ---
# Source:  #             the forward-confirmation step of _verified_rdns().
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (2 variants — one test should kill all):
#   Numeric boundary flip == to !=
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_938_13_!= line 938 in _verified_rdns()';
    # NOTE: new() called with no arguments as a starting point.
    # If CGI::ACL requires constructor arguments, add them here.
    my $obj = new_ok('CGI::ACL');
    # TODO: exercise line 938 in _verified_rdns() to detect the mutant
