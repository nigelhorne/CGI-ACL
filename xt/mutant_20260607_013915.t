...
# Source:  # ── Cloud check (highest precedence; overrides allow_ip) ────────────────
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
...
# Source:  #               SIGALRM handler on non-Windows platforms.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # IPv6: use inet_pton which handles all valid IPv6 formats
...
# Source:  : Socket::inet_ntop(Socket::AF_INET6, $packed);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # Side effects: Performs a DNS A or AAAA lookup.
# Hint:    Likely missing edge-case test (boundary value)
