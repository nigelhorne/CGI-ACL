...
# Source:  # Wrap in eval in case the list was built from partly-invalid entries.
...
# Source:  #             condition for the country check to have any effect — allow_countries
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
