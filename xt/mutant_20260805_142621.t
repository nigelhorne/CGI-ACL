...
# Source:  # Guard 3: an empty arrayref is a no-op — do not create allow_countries = {}
...
# Source:  # Check whether the address falls inside any allowed CIDR range.
...
# Source:  # Conclusion: deny_countries being non-empty is the necessary and sufficient
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
